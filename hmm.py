...
class HiddenMarkovModel(object):
    ...
    def viterbi_inference(self, obs_seq):
        ...
        with tf.name_scope('Emission_seq_'):
            ...
            obs_prob_list = tf.split(num_or_size_splits=self.N, value=obs_prob_seq)
    ...
    def forward_backward(self, obs_prob_seq):
        ...
        """
        obs_prob_list_for = tf.split(num_or_size_splits=self.N, value=obs_prob_seq)
        ...
        obs_prob_list_back = tf.split(num_or_size_splits=self.N, value=obs_prob_seq_rev)
